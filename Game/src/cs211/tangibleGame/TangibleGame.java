...
public class TangibleGame extends PApplet {
	...
	// Board values
	protected static final int BOARD_THICKNESS = 20;
	protected static final int BOARD_SIZE = 700;
	protected static float rotX, rotY, rotZ;
	protected float diffX, diffY;
	protected float speed;
	protected static float score, lastScore;
	protected double time;

	// Ball values
	protected static final int BALL_RADIUS = 20;

	// Global values
	protected final int DEPTH = 2000;
	protected final float miniRectSize = 10.0f;
	protected boolean interactionMode, canAddCylinder;
	
	protected Mover ball;
	protected Cylinder cylinder;
	protected static ArrayList<Cylinder> cylinders;
	
	protected ArrayList<Float> scores;
	protected PGraphics dataVisualization, topView, scoreboard, barChart;
	protected HScrollbar hs;
	
	protected static PShape olaf;
